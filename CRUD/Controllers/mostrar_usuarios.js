...
function editUser(user) {
    ...
    const newFechaNacimiento = prompt('Ingrese la nueva fecha de nacimiento:', user.fechaNacimiento);
    const newDireccion = prompt('Ingrese la nueva dirección:', user.direccion);
    const newTelefono = prompt('Ingrese el nuevo teléfono:', user.telefono);

    if (newCedula && newFechaNacimiento && newDireccion && newTelefono) {
        updateUser(user.id, {
            cedula: newCedula,
